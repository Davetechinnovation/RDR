        ...
        <div>
          ...
          <div className="flex gap-2 items-center">
            <a
              ...
              className="bg-[#DF383D] sm:w-[48px] sm:h-[48px] w-[38px] h-[38px] rounded-full flex justify-center items-center hover:opacity-90 transition-opacity"
            >
              <svg
                width="14"
                height="14"
            ...
            <a
              href="https://x.com/danraphservices"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-[#DF383D] sm:w-[48px] sm:h-[48px] w-[38px] h-[38px] rounded-full flex justify-center items-center hover:opacity-90 transition-opacity"
            >
            ...
            >
              <svg
                ...
                fill="currentColor"
              >
                <path d="M201.5 73.9a48.2 48.2 0 0 1-28.8-9.6v75.2a64.8 64.8 0 1 1-64.8-64.8 63.7 63.7 0 0 1 13.4 1.4v32.8a32.3 32.3 0 1 0 19.4 29.7V32h32a48.3 48.3 0 0 0 28.8 9.6z" />
              </svg>
            </a>
          </div>
        </div>
